...
#output 1 = the fasta with feature_# as a header
#output 2= a tsv with the feature and taxonomy 

##download the dada2 formatted database - not 9 levels of taxonomy vs the previous 7
